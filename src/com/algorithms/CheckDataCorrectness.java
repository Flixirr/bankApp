...
public interface CheckDataCorrectness {

    static boolean checkForDataType(String PESEL, String password, String name, String surname) {
        String numReg = ".*[0-9]+.*";
    ...
    static boolean checkAccNum(String accNum) {
        ...
        if(r) {
            ...
            return ButtonActions.getNumUserPair().containsKey(test);
        }

        return false;
    }

    static boolean checkAmountProv(String amount) {
